...
class TermVdw: public EnergyTermCommon<TermVdw, ChainFB> {

protected:

     //! For convenience, define local EnergyTermCommon
     typedef phaistos::EnergyTermCommon<TermVdw, ChainFB> EnergyTermCommon;
...
public:
     ...
     TermVdw(ChainFB *chain,
                 const Settings &settings = Settings(),
                 RandomNumberEngine *random_number_engine = &random_global)
          : EnergyTermCommon(chain, "energy-vdw", settings, random_number_engine) {
