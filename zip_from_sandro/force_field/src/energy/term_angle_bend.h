...
#ifndef TERM_ANGLEBEND_H
#define TERM_ANGLEBEND_H
...
class TermAngleBendBase: public EnergyTermCommon<DERIVED_CLASS,ChainFB> {
     ...
     TermAngleBendBase(ChainFB *chain, std::string name, const Settings &settings = Settings(),
     ...
     //! \param chain Molecule chain
     TermAngleBendBase(const TermAngleBendBase &other,
...
class TermAngleBend: public TermAngleBendBase<TermAngleBend> {

public:

     //! For convenience, define local TermAngleBendBase
     typedef phaistos::TermAngleBendBase<TermAngleBend> TermAngleBendBase;

     //! Reuse base-class Settings object
     typedef TermAngleBendBase::Settings Settings;

     //! Constructor
     TermAngleBend(ChainFB *chain, const Settings &settings = Settings(),
                       RandomNumberEngine *random_number_engine = &random_global)
          : TermAngleBendBase(chain, "-angle-bend", settings, random_number_engine) {}

     //! Copy constructor
     TermAngleBend(const TermAngleBend &other,
                       RandomNumberEngine *random_number_engine,
                       int thread_index, ChainFB *chain)
          : TermAngleBendBase(other, random_number_engine, thread_index, chain) {
     }
};
