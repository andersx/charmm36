...
#ifndef TERM_TORSION_H
#define TERM_TORSION_H
...
//! torion energy term
class TermTorsion: public EnergyTermCommon<TermTorsion, ChainFB> {

private:

     //! For convenience, define local EnergyTermCommon
     typedef phaistos::EnergyTermCommon<TermTorsion, ChainFB> EnergyTermCommon;
...
public:
     ...
     TermTorsion(ChainFB *chain, 
                     const Settings &settings=Settings(),
                     RandomNumberEngine *random_number_engine = &random_global) 
          : EnergyTermCommon(chain, "torsion", settings, random_number_engine) {
     ...
     //! \param chain Molecule chain
     TermTorsion(const TermTorsion &other, 
