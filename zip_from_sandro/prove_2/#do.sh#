...
name=$2
# Create gro and top
pdb2gmx -f ${pdb} -o ${name}.gro -p ${name}.top -ignh <<EOF
8
6
EOF

# Do a 1000 step minimization 
grompp -f mini.mdp -c ${name}.gro -p ${name}.top  -o ${name}.tpr
mdrun -s ${name}.tpr -x minitraj_1.xtc -c ${name}_gromacs.pdb 
# Creat new gro
#rm \#*
